...
let score1 = 100;
let str = "cheek";
console.log(Array.of(score1, str));
...
console.log(Array.from(obj));   //it'll give an empty array and if you want an array of keys only
console.log(Object.keys(obj));
console.log(Object.values(obj));    //an array of values only
console.log(Object.entries(obj));    //an array of all the [key:value] pair of an object